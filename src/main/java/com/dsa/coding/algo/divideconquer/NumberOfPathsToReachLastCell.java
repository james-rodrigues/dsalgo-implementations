...
/**
 * The Class NumberOfPathsToReachLastCell_DC.
 */
public class NumberOfPathsToReachLastCell {
	...
	public int numberOfPaths(int array[][], int row, int col, int cost) {
		...
		int noOfPathsFromPreviousRow = numberOfPaths(array, row - 1, col, cost - array[row][col]); // Find Paths till
																									// last Row
		int noOfPathsFromPreviousCol = numberOfPaths(array, row, col - 1, cost - array[row][col]); // Find Paths till
																									// last Col
