package com.dsa.coding.ds.trie;
...
public class TrieImpl {
	...
	public static void main(String[] args) {
		...
		/*
		 * //CASE#2 t.insert("bcde"); t.insert("bcdefg"); t.delete("bcde");
		 * t.search("bcde"); t.search("bcdefg");
		 */

		/*
		 * //CASE#3 t.insert("bcde"); t.insert("bc"); t.delete("bcde");
		 * t.search("bcde"); t.search("bcde"); t.search("bc"); t.search("b");
		 */

		/*
		 * //CASE#4 t.insert("bcde"); t.delete("bcde"); t.search("bcde");
		 */
